...
class TaskControllerTest {
    ...
    @Test
    void should_save_and_retrieve_taks_by_id() throws Exception {
        Map<String, String> taskRequest = new HashMap<>();
        taskRequest.put("title", "Aprender Spring RestDocs");
        taskRequest.put("description", "Ler o guia oficial");
        ...
        String responseJson = this.mockMvc.perform(
                ...
                .andDo(document("create-task",
                        requestFields(
                                fieldWithPath("title").description("Titulo da tarefa"),
                                fieldWithPath("description").description("Descrição detalhada")
                        ),
                        responseFields(
                                fieldWithPath("id").description("Titulo da tarefa"),
                                fieldWithPath("title").description("Titulo da tarefa"),
                                fieldWithPath("description").description("Descricao detalhada"),
        ...
        this.mockMvc.perform(
                ...
                .andDo((document("get-taks-by-id",
                        pathParameters(
                                parameterWithName("id").description("identificador unico da tarefa")
                        ),
                        responseFields(
                                fieldWithPath("id").description("Identificador unico da tarefa"),
                                fieldWithPath("title").description("Titulo da tarefa"),
                                fieldWithPath("description").description("Descricao detalhada"),
                                fieldWithPath("status").description("Status da tarefa")
                        )
